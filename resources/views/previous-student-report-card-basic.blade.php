                                                ...
                                                <table width="1700" class="border-line">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center px-1" style="font-size: 1.5em;">
                                                            ...
                                                            @if($student->class_stage_id == 7)
                                                            <td>{{$result->previousClassSubject($student, $result->subject->id, $given_session_id, $given_term_id)->count()}}</td>
                                                            @endif
                                                            ...
                                                            <td>
                                                                {{$result->previousSubjectTeacher($result->subject->id, $result->classlevel->id, $given_session_id, $given_term_id)->lastname}}
                                                                {{abbreviate($result->previousSubjectTeacher($result->subject->id, $result->classlevel->id, $given_session_id, $given_term_id)->firstname)}}
                                                            </td>
                                                        </tr>
                                                        @endforeach
